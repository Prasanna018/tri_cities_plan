    ...
    return (
        <div className='p-4 bg-[#1e2a3a]'>
            <div>
                ...
                <p className='py-2'>
                    The Tri-Cities Area MPO is expanding Environmental Justice (EJ) considerations in its transportation planning and programming processes as part of the new EJ Plan. EJ, at its core, is ensuring disadvantaged populations do not face higher and more adverse impacts of public programs or projects than the rest of the population. Throughout history, low income and minority populations have endured discrimination, been excluded from the decision-making process, and have often faced more neighborhood and localized impacts, worse air quality, and fewer services.
                    <br></br>
            ...
            <div className='py-4'>
                <h1 className='text-3xl font-bold'>What does “minority” or “low income” actually mean?</h1>
                <p className='py-3'>
                    ...
                    <br></br>
                    <b> Low Income</b> – Household income is at or below the Department of Health and Human Services (HHS) poverty guidelines.
                    <br></br>
                    <b>
                        Low income population</b> – Any readily identifiable group of low-income persons who live in geographic proximity.
                    <br></br>

                    <b> Minority</b> – Populations including Black, Hispanic or Latin, Asian American, American Indian and Alaskan Native, and/or Native Hawaiian or Pacific Islander as self-identified in the Census.
                    <br></br>

                    <b> Minority population</b> – Any readily identifiable group of minority persons who live in geographic proximity.
                    <br></br>
            ...
            <div className='py-4'>
                <h1 className='text-3xl font-bold'>What does EJ look like in the NFRMPO region no</h1>
                <p>
            ...
            <div className='py-4'>
                <h1 className='text-3xl font-bold'>Additional Equity Considerations</h1>
                <p>
            ...
            <div className='py-4'>
                <h1 className='text-3xl font-bold'>Justice 40</h1>
                <p>
            ...
            <div className='py-4'>
                ...
                <p>
                    ...
                    The EnviroScreen Score is calculated using the 35 indicators which are grouped into two broad categories: Health & Social Factors and Pollution & Climate Burden. More information about the EnviroScreen indicators and a mapping tool created to view DI Communities in Colorado can be found at {" "}
                    <a
            ...
            <div className='py-4'>
                <h1 className='py-2 text-3xl font-bold'>Equity Index</h1>
                <p className='py-2'>
            ...
            <div className='py-4'>
                <h1 className='py-2 text-3xl font-bold'>EJ Plan</h1>
                <p>
                    <a
                        href='https://nfrmpo.org/wp-content/uploads/2021-environmental-justice-plan.pdf'
                        target='_blank'
                        className='text-blue-500 hover:underline'

                    >2021 Environmental Justice (EJ) Plan</a>
                    <br>
                    </br>
            ...
            <div className='py-3'>
                <h1 className='text-3xl font-bold'>What are some EJ Best Practices from the NFRMPO region?</h1>
                <p>The EJ Plan serves as a toolkit for NFRMPO staff, local agencies, and other partners. NFRMPO Staff will work with stakeholder groups such as the Community Advisory Committee (CAC) to implement the recommendations from the EJ Plan.</p>

            </div>

            <div className='py-4'>
                <h1 className='font-bold text-3xl'>What are some EJ Best Practices from the NFRMPO region?</h1>
                <p>NFRMPO staff have met with and continue to meet with stakeholders around the region, learning about what local governments have been doing to increase access to the local planning and programming processes.
